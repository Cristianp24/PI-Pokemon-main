  ...
  switch (action.type) {
    ...
    case ORDER_ATTACK:
      if (action.payload === "(+-) Attack") {
        return {
          ...state,
          PokemonsFiltereds: state.pokemons.sort((a, b) => b.attack - a.attack),
        };
      } else if (action.payload === "(-+) Attack") {
        return {
          ...state,
          PokemonsFiltereds: state.pokemons.sort((a, b) => a.attack - b.attack),
        };
      }
      break;
    ...
    case GET_TYPES:
      ...
      return {
        ...
        numPage: 1,
      //en mi estado filteredPokemons suceda todo lo de arriba,ya que no se puede hacer logica adentro del return.
      };
